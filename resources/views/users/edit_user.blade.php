                  ...
                  {{-- <div class="table-responsive m-t-40">
                    <div id="example23_wrapper" class="dataTables_wrapper">
                      ...
                      {{-- <form method='PUT' action="{{route('User.update',['id'=>$SystemUser->id])}}" role="form">
                        {{method_field('PUT') }}
                        {{csrf_field()}} --}}
                      {!! Form::open(['route' => ['User.update', $SystemUser->id] , 'method'=>'PATCH']) !!}
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" id="name" name="name" value="{{$SystemUser->name}}"></td>
                                    <td><input type="email" class="form-control" id="email" name="email" value="{{$SystemUser->email}}"></td>
                                    <td><input type="password" class="form-control" id="password" name="password" placeholder="new password...."></td>
                                    <td><input type="text" class="form-control" id="phone_number" name="phone_number" value="{{$SystemUser->phone_number}}"></td>
                                    <td><input type="number" class="form-control" id="points" name="points" value="{{$SystemUser->points}}"></td>
                                    <td><input type="number" class="form-control" id="consumed_points" name="consumed_points" value="{{$SystemUser->consumed_points}}"></td>
                                    ...
                                    <td>
                                      <a name="cancel" id="cancel" href="{{route('User.show',['id'=>$SystemUser->id])}}" class="btn btn-dark btn-rounded m-b-10 m-l-5">Cancel</a>
                                    </td>
